...
public final class Renderer {
     ...
     */
    public final int VERTEX_LENGTH = 7;
    public int verticesPerObject = 0;
    public int indicesPerObject = 0;
    public final int MAX_LIGHTS = 10;
    private final VAO vao = new VAO();
    private int viewUniform;
    private int projectionUniform;
    private final ArrayList<RenderObject> objects = new ArrayList<>();
    private final FastLinkedList<RenderObject> visible = new FastLinkedList<>();
    private final ArrayList<PointLight> lights = new ArrayList<>();
    private PointLight[] visibleLights = new PointLight[MAX_LIGHTS];
    private final int[] lightPositionUniforms = new int[MAX_LIGHTS];
    private final int[] lightColorUniforms = new int[MAX_LIGHTS];
    private final int[] lightIntensityUniforms = new int[MAX_LIGHTS];
    ...
    public void initializeRectRenderer(OrthographicCamera2D camera){
    ...
    public void initialize(float[] objectVertices, int[] objectIndices, OrthographicCamera2D camera){
